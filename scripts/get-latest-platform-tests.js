...
const commitHash = "762a7a6ec01142fe9cfe6979034582bffdd3c66f";
...
const toASCIISourceURL = `https://raw.githubusercontent.com/w3c/web-platform-tests/${commitHash}/url/toascii.json`;
...
request.get(toASCIISourceURL)
  .pipe(fs.createWriteStream(path.resolve(targetDir, "toascii.json")));
